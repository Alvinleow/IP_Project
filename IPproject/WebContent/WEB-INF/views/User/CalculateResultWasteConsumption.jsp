...
<body>
    ...
    <div class="main-content">
        <div class="contain-container">
            ...
            <h1 class="description">Carbon Footprint Calculation Result for Waste</h1>
            ...
            <div class="calculation-details">
                <p>[Waste Consumption] kg x [CO2PerKg] kgCO2 /kg = [Carbon Footprint kgCO2</p>
                <p>${WasteConsumption} kg x ${co2PerKg} kgCO2/kg = ${carbonFootprint} kgCO2</p>
            </div>
            <div class="button-container">
