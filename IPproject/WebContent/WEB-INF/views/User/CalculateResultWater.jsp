...
<body>
  ...
  <div class="main-content">
    <div class="contain-container">
      ...
      <h1 class="description">Carbon Footprint Calculation Result for Water - ${billMonth}</h1>
      <div class="result-value">${carbonFootprint} kgCO<sub>2</sub></div>
      <div class="button-container">
        <button id="show-calculation" class="show-calculation">Show Calculation</button>
      </div>
      <div class="calculation-details">
      	<p>[Water Consumption] m³ x [co2PerCubicMeter] kgCO2 /m³ = [Carbon Footprint] kgCO2</p>
  ...
  <script>
      // Load sidebar
      $(function(){
          $("#sidebar").load("<c:url value='/User/sidebarUser.jsp'/>"); 
      });
